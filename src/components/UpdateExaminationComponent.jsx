...
class UpdateExaminationComponent extends Component {
    constructor(props) {
        super(props)
    ...
    updateExamination = (e) => {
        ...
        console.log('examinationID => ' + JSON.stringify(this.state.examinationID));
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.updateExamination}>Save</button>
...
export default UpdateExaminationComponent
