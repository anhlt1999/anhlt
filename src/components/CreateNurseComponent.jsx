...
class CreateNurseComponent extends Component {
    ...
    getTitle(){
        if(this.state.nurseID === '_add'){
            return <h3 className="text-center">Add nurse</h3>
        }else{
            return <h3 className="text-center">Update nurse</h3>
        }
    }
    render() {
        return (
                            ...
                            <div className = "card col-md-7 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    <form>
                                        ...
                                        <button className="btn btn-success" onClick={this.saveOrUpdateNurse}>Save</button>
